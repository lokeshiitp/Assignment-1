// Program Name:- Implements Various Queues Functions using Dynamic Memory Allocation

// INPUT:-
#include <stdio.h>
#include <stdlib.h>
#define MAX 10
struct node         // node form
{
    int data;
    struct node *link;
} * front, *rear;
...
void main()         // main function excution 
{ 
    int choice, value;
    while (1)
    {
...
void insert()                          // insert function excution
{
    struct node *temp;
